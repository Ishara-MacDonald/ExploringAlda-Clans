...
public class Grinder : CraftingGear
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (materialList.Count == 0 && other.CompareTag("Drag"))
        {
            ...
            if (!other.gameObject.TryGetComponent<OCraftingMaterial>(out var material)) return;
    ...
    private void OnEnableColliders()
    {
        ...
        OGrabber.OnLetGoItem -= OnEnableColliders;
    }
    ...
    public override GameObject OnGrab()
    {
        if (materialList.Count > 0)
        {
            ...
            OCraftingMaterial material = materialList[0];
            materialList.Remove(material);
            TransferItem(material.transform, false);
            return material.gameObject;
        }
        return null;
    }
    ...
    public override void OnUse()
    {
        ...
        {
            foreach (OCraftingMaterial material in materialList)
            {
                ItemDataSO itemData = material.GetComponent<OCraftingMaterial>().ItemData;
